...
public class mediuml4 extends JFrame
{
    ...
    public mediuml4()
    {
        ...
        JLabel j1=new JLabel("Enter a number b/w 0-10");
        j1.setFont(new Font("tunga",Font.PLAIN,17));
        j1.setSize(300,20);
        j1.setLocation(350,200);

        JLabel jx=new JLabel("Enter b number b/w 0-10");
        jx.setFont(new Font("tunga",Font.PLAIN,17));
        jx.setSize(270,20);
        jx.setLocation(350,400);
        c.add(jx);
        JLabel jz=new JLabel("Your multiplied (a*b) values are:"+rand+"Find the a=? & b=? values!!");
