...
public class mediuml2 extends JFrame
{
    ...
    int a11=r.nextInt(1000);
    int b11=r1.nextInt(1000);
    ...
    public mediuml2()
    {
        ...
        JLabel j1=new JLabel("Enter a number b/w 0-1000");
        j1.setFont(new Font("tunga",Font.PLAIN,17));
        j1.setSize(300,20);
        j1.setLocation(350,200);

        JLabel jx=new JLabel("Enter b number b/w 0-1000");
        jx.setFont(new Font("tunga",Font.PLAIN,17));
        jx.setSize(270,20);
        jx.setLocation(350,400);
        c.add(jx);
        JLabel jz=new JLabel("Your added (a+b) values are:"+rand+"Find the a=? & b=? values!!");
